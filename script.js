...
function showNewAlarm(newAlarm){
    ...
    <li class = "time-list">        
        ...
        <button class="deleteAlarm time-control" id="delete-button" onclick = "remove(this.value)" value=${newAlarm}>Delete Alarm<ion-icon name="trash-outline"></ion-icon></button>       
    </li>`
